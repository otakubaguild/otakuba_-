...
(async function(){
  ...
  function welcomePrompt(){
    ...
    return (window.GuildTheme&&GuildTheme.m?GuildTheme.m('openMenu'):'メニューを開きますか？');
  }
  ...
  $('btnBackTitle').onclick=()=>{ GuildAudio.playSe('cancel'); GuildUI.closeModals(); showWelcomeScreen(); };
